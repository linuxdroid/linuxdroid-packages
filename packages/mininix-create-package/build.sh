MININIX_PKG_HOMEPAGE=https://github.com/linuxdroid/mininix-create-package
...
MININIX_PKG_SRCURL=https://github.com/linuxdroid/mininix-create-package/archive/v${MININIX_PKG_VERSION}.tar.gz
