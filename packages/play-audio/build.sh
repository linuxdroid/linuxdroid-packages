MININIX_PKG_HOMEPAGE=https://github.com/linuxdroid/play-audio
...
MININIX_PKG_SRCURL=https://github.com/linuxdroid/play-audio/archive/v${MININIX_PKG_VERSION}.tar.gz
