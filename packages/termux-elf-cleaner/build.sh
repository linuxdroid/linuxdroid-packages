MININIX_PKG_HOMEPAGE=https://github.com/linuxdroid/mininix-elf-cleaner
...
MININIX_PKG_SRCURL=https://github.com/linuxdroid/mininix-elf-cleaner/archive/v${MININIX_PKG_VERSION}.tar.gz
