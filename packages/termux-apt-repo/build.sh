MININIX_PKG_HOMEPAGE=https://github.com/linuxdroid/mininix-apt-repo
...
MININIX_PKG_SRCURL=https://github.com/linuxdroid/mininix-apt-repo/archive/v${MININIX_PKG_VERSION}.tar.gz
