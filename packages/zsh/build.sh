...
mininix_step_post_configure () {
	...
	# - The files module is needed by `compinstall` (https://github.com/linuxdroid/mininix-packages/issues/61).
	...
	# - The deltochar and mathfunc modules is used by grml-zshrc (https://github.com/linuxdroid/mininix-packages/issues/494).
	# - The system module is needed by zplug (https://github.com/linuxdroid/mininix-packages/issues/659).
	# - The zpty module is needed by zsh-async (https://github.com/linuxdroid/mininix-packages/issues/672).
	# - The stat module is needed by zui (https://github.com/linuxdroid/mininix-packages/issues/2829).
