...
mininix_step_post_make_install () {
	...
	sed 's',"--sysroot=$MININIX_STANDALONE_TOOLCHAIN"/sysroot,"-I/data/data/mini.nix/home/usr/include",'g' Config_heavy.pl > Config_heavy.pl.new
	sed 's',"$MININIX_STANDALONE_TOOLCHAIN"/sysroot,"-I/data/data/mini.nix/home",'g' Config_heavy.pl.new > Config_heavy.pl
