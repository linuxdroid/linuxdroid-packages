MININIX_PKG_HOMEPAGE=https://github.com/linuxdroid/libandroid-support
...
MININIX_PKG_SRCURL=https://github.com/linuxdroid/libandroid-support/archive/v${MININIX_PKG_VERSION}.tar.gz
