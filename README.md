...
- The Mininix build system uses [mininix-elf-cleaner](https://github.com/linuxdroid/mininix-elf-cleaner) to strip away unused ELF entries causing the above mentioned linker warnings.
